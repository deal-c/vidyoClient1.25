		...
		AsyncTask<JsonHttp.Arguments, Integer, JsonHttp.Arguments>
{
	...
	@Override
	protected JsonHttp.Arguments doInBackground(JsonHttp.Arguments... params)
	{
		Log.i(TAG, "doInBackground Begin");
		JsonHttp.Arguments args = params[0];
	...
	//请求结果处理.
	@Override
	protected void onPostExecute(JsonHttp.Arguments args)
	{
		publishProgress(PROGRESS_DONE);
