		...
		AsyncTask<LoginHttp.Arguments, Integer, LoginHttp.Arguments>
{
	...
	@Override
	protected LoginHttp.Arguments doInBackground(LoginHttp.Arguments... params)
	{
		...
		LoginHttp.Arguments args = params[0];
	...
	@Override
	protected void onPostExecute(LoginHttp.Arguments args)
	{
		publishProgress(PROGRESS_DONE);
