		...
		AsyncTask<EnterRoomHttp.Arguments, Integer, EnterRoomHttp.Arguments>
{
	...
	@Override
	protected EnterRoomHttp.Arguments doInBackground(EnterRoomHttp.Arguments... params)
	{
		
		String portal = "http://";

		EnterRoomHttp.Arguments args = params[0];
	...
	@Override
	protected void onPostExecute(EnterRoomHttp.Arguments args)
	{
		publishProgress(PROGRESS_DONE);
